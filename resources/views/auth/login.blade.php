    ...
    <div class="container-fluid" style="position: relative;height: 100%">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 background-mobile" style="height: 100%;">
                ...
                <form class="form-login background-mobile" style="background-color: #d51100"action="{{ route('login') }}" method = "post">
                    {{ csrf_field() }}
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input style="text-align: center;" id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus placeholder="Email">
                    @if ($errors->has('email'))
