...
Route::group(['middleware'=>['auth']], function()
{
	...
	Route::get('/AM-form-aspek/{id}/{id_proyek}','AMController@indexAspek')->name('aspek');
	Route::get('/AM-form-aspek/insert/{id}/{id_proyek}','AMController@insertAspek')->name('aspek_insert');
